jQuery(document).ready(function ($) {
    ...
    function s(n) {
        (window.location.href.indexOf("rle") || 0 != window.location.port.length) && n.each(function () {
            var n = $(this), s = n.text().split(""), e = n.hasClass("is-visible");
    ...
    function e(i) {
        ...
        i.each(function () {
            ...
            }, u); else if (i.hasClass("clip")) {
                var s = i.find(".cd-words-wrapper"), e = s.width() + 10;
                s.css("width", e)
            } else if (!i.hasClass("type")) {
                var a = i.find(".cd-words-wrapper b"), o = 0;
                a.each(function () {
                    var i = $(this).width();
                    i > o && (o = i)
    ...
    function t(i) {
        ...
        } else i.parents(".cd-headline").hasClass("clip") ? i.parents(".cd-words-wrapper").animate({width: "2px"}, C, function () {
            c(i, n), a(n)
    ...
    function a(i, n) {
        i.parents(".cd-headline").hasClass("type") ? (d(i.find("i").eq(0), i, !1, n), i.addClass("is-visible").removeClass("is-hidden")) : i.parents(".cd-headline").hasClass("clip") && i.parents(".cd-words-wrapper").animate({width: i.width() + 10}, C, function () {
            setTimeout(function () {
                t(i)
            }, b)
        })
    ...
    var f = 2e3, h = 3e3, u = h - 3e3, p = 25, w = 75, m = 200, v = m + 100, C = 400, b = 1e3;
    n()
}), jQuery(document).ready(function ($) {
    function i(i) {
        var s = i.width() / 2, e = i.offset().left + s, t = i.offset().top + s - $(window).scrollTop(),
            a = n(t, e, s, $(window).height(), $(window).width());
        return i.css("position", "fixed").velocity({top: t - s, left: e - s, translateX: 0}, 0), a
    }

    function n(i, n, s, e, t) {
        var a = n > e / 2 ? n : e - n, o = i > t / 2 ? i : t - i;
        return Math.ceil(Math.sqrt(Math.pow(a, 2) + Math.pow(o, 2)) / s)
    }

    function s(i, n, s) {
        i.velocity({scale: n}, 400, function () {
    ...
    function e() {
        var i = $(".cd-section.modal-is-visible").find(".cd-modal-bg"), s = i.width() / 2,
            e = i.siblings(".btn").offset().top + s - $(window).scrollTop(), t = i.siblings(".btn").offset().left + s,
            a = n(e, t, s, $(window).height(), $(window).width());
        i.velocity({top: e - s, left: t - s, scale: a}, 0)
    }
    ...
    $('[data-type="modal-trigger"]').on("click", function () {
        var n = $(this), e = i(n.next(".cd-modal-bg"));
    ...
    $(".page-scroll a").bind("click", function (i) {
        var n = $(this);
        $("html, body").stop().animate({scrollTop: $(n.attr("href")).offset().top}, 1500, "easeInOutExpo"), i.preventDefault()
    })
});